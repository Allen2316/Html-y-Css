...
class Cliente(models.Model):
    ...
    genero = models.CharField(
        max_length=30, choices=listaGenero, default="femenino")
    estadoCivil = models.CharField(max_length=30,
                                   choices=listaEstadoCivil, null=False, default="soltero")
...
class Cuenta(models.Model):
    ...
    tipoCuenta = models.CharField(
        max_length=30, choices=listaTipoCuenta, default='ahorros')
...
class Transaccion(models.Model):
    ...
    tipo = models.CharField(
        max_length=30, choices=listaTipoTransaccion, default='deposito')
