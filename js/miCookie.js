//metodos que defines la teoria de cookies
...
var crear = function () {
    ...
    var expiracion = prompt("Ingresar el numero de dias de la cookie");
...
var buscar = function () {
    var nombre = prompt("Ingresar el nombre de la cookie a buscar");            
...
window.onload = function () {
    ...
    botonVC.onclick = function () {
        //document.write("A preparase mas y mas");
        verCookies();
    };
